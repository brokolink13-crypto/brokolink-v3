  ...
  return (
    <aside className="hidden lg:flex flex-col w-64 h-screen sticky top-0 border-r border-neutral-100 bg-white">
          ...
          return (
            <Link
              ...
              className={cn(
                ...
                isActive
                  ? "bg-broko-light text-broko-primary"
      ...
      <div className="px-3 py-4 border-t border-neutral-100">
        <button
          onClick={() => logout()}
          className="flex items-center gap-3 px-3 py-2.5 rounded-lg text-body-sm font-medium text-neutral-500 hover:text-red-600 hover:bg-red-50 transition-all duration-200 w-full"
        >
